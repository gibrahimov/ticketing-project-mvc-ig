...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        //create some roles and put in the DB(our Map)
        //create some user and put into DB(map)
        ...
        //now add role in the DB(map)

        /*
        RoleService rs = new RoleServiceImpl();
        rs.save(adminRole);
        We have save() method in RoleServiceImpl class that save RoleDTO object in to the map.
Which we can use it in here actually, but it is not a good structure because it is tightly coupled,
we are directly using RoleServiceImpl object.
         */
